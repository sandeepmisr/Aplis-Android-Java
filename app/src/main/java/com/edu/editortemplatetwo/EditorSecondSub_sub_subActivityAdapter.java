...
public class EditorSecondSub_sub_subActivityAdapter extends RecyclerView.Adapter<EditorSecondSub_sub_subActivityAdapter.SampleViewHolders>
{
    private List<EditorSubModel> itemList;
    private Context context;
    private ClickAdapter clickAdapter;
    public EditorSecondSub_sub_subActivityAdapter(Context context, List<EditorSubModel> itemList, ClickAdapter clickAdapter)
    {
...
//                        clickAdapter.clickoncard(Integer.parseInt(itemList.get(position).getId()),itemList.get(position).getMime_type(),itemList.get(position).getSub_title(),itemList.get(position).getTitle(),itemList.get(position).getDescription(),null,null,null);
